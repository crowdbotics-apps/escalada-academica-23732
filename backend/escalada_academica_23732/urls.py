"""escalada_academica_23732 URL Configuration
...
admin.site.site_header = "Escalada Academica"
admin.site.site_title = "Escalada Academica Admin Portal"
admin.site.index_title = "Escalada Academica Admin"

# swagger
api_info = openapi.Info(
    title="Escalada Academica API",
    default_version="v1",
    description="API documentation for Escalada Academica App",
)
